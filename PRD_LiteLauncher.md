...
1. 继续收敛 WebTools 功能齐平与交互一致性。
2. 继续完善文案与编码清理。
3. 测试覆盖、自动更新验证、签名与公证作为自用阶段低优先级收尾项。

## 7. 版本路线

1. `v1.1`：插件面板拆分、小屏稳定性提升、Cashflow 复盘。
2. `v1.2`：WebTools 交互收敛、文案与编码清理、Cashflow AI 多性格策略。
3. `v2.x`：插件生态、自动更新闭环、签名与公证完善，以及更完整的自动化测试覆盖。
