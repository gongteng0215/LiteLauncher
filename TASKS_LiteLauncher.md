...
1. v1.1.17 已收口只读线上更新校验、Cashflow 长期存档回归、真实 Windows LiteSnap 双向滚动门禁和八工具独立粗细。
2. 发布后只读验证 `v1.1.16 -> v1.1.17` Latest Release、`latest.yml`、NSIS、blockmap、大小与发布说明，不下载安装包。
