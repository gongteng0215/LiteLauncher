export const IPC_CHANNELS = {
  ...
  liteSnapClearDiagnostics: "launcher:litesnap-clear-diagnostics",
  ...
  dictionaryPackDownloadProgress: "launcher:dictionary-pack-download-progress",
  ...
  addCustomPinnedPath: "launcher:add-custom-pinned-path",
